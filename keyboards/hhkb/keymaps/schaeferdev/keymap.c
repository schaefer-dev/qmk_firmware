...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    /* BASE Level: Default Layer
     ...
     |--------+---+---+---+---+---+---+---+---+---+---+-------+-----+-------+-----|
     | Shift  | Z | X | C | V | B | N | M | , | . | / | Shift |MOUSE|       |     |
     |--------+---+---+---+---+---+---+---+---+---+---+-------+-----+-------+-----|
            |------+------+-----------------------+------+------|
            | GUI  | LAlt | ******* Space ******* | Fn0  | RAlt |
            |------+------+-----------------------+------+------|
    */
    ...
    [BASE] = LAYOUT( //  default layer
        ...
        KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, MO(MOVEMENT),
        KC_LGUI, KC_LALT, /*          */ KC_SPC, /*       */ MO(HHKB), KC_RALT),

    /* Layer HHKB: HHKB mode (HHKB Fn)
      |------+-----+-----+-----+----+----+----+----+-----+-----+-----+-----+-------+-------+-----|
      | `~   | F1  | F2  | F3  | F4 | F5 | F6 | F7 | F8  | F9  | F10 | F11 | F12   | DEL   | PWR |
      |------+-----+-----+-----+----+----+----+----+-----+-----+-----+-----+-------+-------+-----|
      | Caps |     | UP  |     |    |    |    |    | UP  | Slk | Pus | Up  |       | Backs |     |
      |------+-----+-----+-----+----+----+----+----+-----+-----+-----+-----+-------+-------+-----|
      |      |LEFT |DOWN |RIGHT |    |    | *  |LEFT|DOWN |RIGHT| Lef | Rig | Enter |       |     |
      |------+-----+-----+-----+----+----+----+----+-----+-----+-----+-----+-------+-------+-----|
    ...
    [HHKB] = LAYOUT(
        ...
        KC_CAPS, KC_TRNS, KC_UP, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_UP, KC_SLCK, KC_PAUS, KC_UP, KC_TRNS, KC_BSPC,
        KC_TRNS, KC_LEFT, KC_DOWN, KC_RIGHT, KC_TRNS, KC_TRNS, KC_PAST, KC_LEFT, KC_DOWN, KC_RIGHT, KC_LEFT, KC_RGHT, KC_PENT,
